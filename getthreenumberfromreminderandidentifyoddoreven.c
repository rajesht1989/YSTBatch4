// get a three number from user and divide and find reminder  them if it is identify the even number
#include<stdio.h>
...
int main(){
    ...
    int reminder = diviThreeNumberFromUser(number1,number2,number3);
